#########################################################
# This file is last modified on 22:45, 6th Nov by Frank #
# The __init__ call shows how to shrink a labelled .csv #
# file.                                                 #
#########################################################
...
preShrunkFilename = sys.argv[1]
ShrunkFilename    = sys.argv[2]
twoMapName        = sys.argv[3]
threeMapName      = sys.argv[4] 
...
'''
# The __main__ function below shrinks the output .csv
# files. For example, if the original sequence is: aa
# aabcca, the function shrinks it into abca
if __name__ == '__main__':
...
#  writeFile2(ShrunkFilename, name, label)
